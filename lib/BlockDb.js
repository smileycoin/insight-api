...
BlockDb.prototype.getServiceAddresses = function(cb) {
    return Rpc.getServiceAddresses(cb);
};

BlockDb.prototype.getOrgList = function(orglistid, cb) {
    return Rpc.getOrgList(orglistid, cb);
}

BlockDb.prototype.getAllOrgLists = function(cb) {
    return Rpc.getAllOrgLists(cb);
}

BlockDb.prototype.getCouponList= function(couponlistid, cb) {
    return Rpc.getCouponList(couponlistid, cb);
}

BlockDb.prototype.getAllCouponLists = function(cb) {
    return Rpc.getAllCouponLists(cb);
}
